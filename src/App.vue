<template>
  ...
  <!-- <div id="gallery">
    <p @click="clickLeft">👈</p>
    <img id="first" src="/durov.webp" alt="durov" />
    <img v-show="isHidden" id="second" src="/lomonosov.webp" alt="durov" />
    <img v-show="isHidden" id="third" src="/pushkin.webp" alt="durov" />
    <p @click="clickRight">👉</p>
  </div> -->
</template>
